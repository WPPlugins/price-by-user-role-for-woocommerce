...
Tags: woocommerce,price by user role
...
**Price by User Role for WooCommerce** plugin lets you display WooCommerce products prices by user roles.
...
1. Upload the entire 'price-by-user-role-for-woocommerce' folder to the '/wp-content/plugins/' directory.
